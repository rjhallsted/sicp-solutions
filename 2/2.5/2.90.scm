...
(define (install-polynomial-package)
    ...
    (put 'add-poly '(sparse sparse) add-polynomial)
    (put 'add-poly '(dense dense) add-polynomial)
    ...
    (put 'mul-poly '(sparse sparse) mul-polynomial)
    (put 'mul-poly '(dense dense) mul-polynomial)
