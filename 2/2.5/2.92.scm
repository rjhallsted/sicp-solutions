...
(define (install-polynomial-package)
    ...
    (define (coerce-poly-to-var p var)
        (display-these "coerce-poly-to-var" p var)
    ...
    (define (poly-equals-zero? p)
        (display-these "poly-equals-zero?" p)
    ...
    (define (empty-termlist? terms)
        (display-these "empty-termlist?" terms)
    ...
    (define (adjoin-term term term-list)
        (display-these "adjoin-term" term term-list)
        (apply-generic 'adjoin-term term term-list))
    (define (order term)
