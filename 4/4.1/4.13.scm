...
(define (make-scanner null-proc eq-proc)
    (define (scan vars vals)
        (cond ((null? vars) (null-proc))
            ((eq? var (car vars)) (eq-proc vars vals))
...
;This only checks the first frame. This is to retain proper scope, abiding by the principle
;that a frame shouldn't be able to alter any of its enclosing frames.
