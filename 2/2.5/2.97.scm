...
(define (install-polynomial-package)
    ...
    (define (div-poly p1 p2)
        (if (same-variable? (variable p1) (variable p2))
            (let ((result (div-terms (term-list p1) 
                                     (coerce-to-type (term-list p2)
                                                     (type-tag (term-list p1))))))
                (list (make-poly (variable p1) (quotient result))
                      (make-poly (variable p1) (remainder result))))
    ...
    (define (sub-poly p1 p2)
     ...
     (define (reduce-poly p1 p2)
        (if (same-variable? (variable p1) (variable p2))
            ...
            (reduce-poly p1 (coerce-poly-to-var p2 (variable p1)))))
    (define (reduce-terms n d)
        (let ((g (gcd-terms n d)))
            (list (quotient (div-terms n g)) (quotient (div-terms d g)))))
    ...
    (define (pseudoremainder-terms a b)
        (remainder (div-terms (integerize a b)
                         b)))
...
(define p1 (make-polynomial 'x '((term 1 1) (term 0 1))))
(define p2 (make-polynomial 'x '((term 3 1) (term 0 -1))))
(define p3 (make-polynomial 'x '((term 1 1))))
(define p4 (make-polynomial 'x '((term 2 1) (term 0 -1))))
