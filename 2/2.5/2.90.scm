...
(define (install-dense-polynomials)
    ...
    (define (adjoin-the-terms term term-list)
        (define (append-zeroes term next-item-order term-list)
            (display "append-zeroes ") (display term) (display " ") (display next-item-order) (newline)
...
(define (install-polynomial-package)
    ...
    (define (coerce-to-type p term-type)
        (if (or (same-variable? (type-tag p) term-type)
                (empty-termlist? p))
            p
        ...
        (cond ((empty-termlist? L1) L2)
            ...
            (else
                (let ((t1 (first-term L1))
                    ...
                    (display t1) (display " ") (display t2) (newline)
                    (newline)
